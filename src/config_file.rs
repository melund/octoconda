    ...
    HashMap::from([
        ...
        (
            ...
            vec![
                ...
                "(^|[\\._-])windows[\\._-](32-bit|i686|x86)(\\.gz|\\.xz|\\.zst|\\.zip|\\.exe)?$".to_string(),
        ...
        (
            ...
            vec![
                ...
                "(^|[\\._-])(windows|win)[\\._-](64-bit|amd64|x86_64|x64)(\\.gz|\\.xz|\\.zst|\\.zip|\\.exe)?$".to_string(),
        ...
        (
            ...
            vec![
                ...
                "(^|[\\._-])(windows|win)[\\._-](arm64|aarch64)(\\.gz|\\.xz|\\.zst|\\.zip|\\.exe)?$".to_string(),
            ],
        ),
    ])
}
